...
export interface HeroSection3DProps extends Base<"blocks.hero-section3-d"> {
   ...
   *  - "policy"             -> HealthPolicyBanner, fan morphing into a cross;
   *                            also uses only the FIRST stage as its tagline
   */
  variant?: "system" | "impact" | "sustain" | "strategy" | "policy" | null;
  heading?: string | null;
...
export interface HeroSectionDigitalWebProps extends Base<"blocks.hero-section-digital-web"> {
  theme: "black" | "blue";
  enum: "brackets" | "code" | "dataflow" | "dashboard" | "pencil";
  heading: string;
  subheader?:string;
  cta?: LinkProps;
  logo?: LogoProps;
