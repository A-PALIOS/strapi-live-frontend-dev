            ...
            <div className="mt-10 grid max-w-2xl grid-cols-2 gap-4 md:grid-cols-4">
              {heroMetrics.map((item) => (
                <div key={item.label} className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur">
                  <div className="text-2xl font-agenda-medium text-white">{item.value}</div>
                  <div className="mt-1 text-lg font-agenda-regular text-white/65">{item.label}</div>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="rounded-[22px] border border-white/10 bg-[#07142a] p-4">
              ...
              <div className="mt-4 grid gap-4 md:grid-cols-[0.9fr_1.1fr]">
                <div className="rounded-2xl border border-white/10 bg-[#0b2143] p-4">
                  ...
                  <label className="mb-4 block text-sm font-agenda-regular text-white/45">Progress target</label>
                  <input
                    type="range"
                    min="35"
                    max="100"
      ...
      <div className="w-full px-6 md:px-10 lg:px-10 xl:px-23 py-16 md:py-20">
        <div className="mb-6 flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-agenda-medium">
    ...
    <section className="bg-[#030912] text-white">
      <div className="w-full px-6 md:px-10 lg:px-10 xl:px-23 py-16 md:py-20">
        <div className="mb-6">
          ...
          <h2 className="mt-2 text-3xl font-agenda-medium">Dashboard Showcase</h2>
          ...
          {showcase.map((item) => {
            ...
            return (
              <button
                ...
                className={`rounded-full px-5 py-3 text-sm font-agenda-medium transition ${
                  isActive
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {active.donut.map((v, i) => (
                      <div key={i} className="rounded-2xl bg-[#07152c] p-4">
                        <div className="text-md font-agenda-regular text-white/45">Segment {i + 1}</div>
                        <div className="mt-2 text-2xl font-agenda-medium text-sky-500">
                          {v}%
                        </div>
                      </div>
                    ))}
