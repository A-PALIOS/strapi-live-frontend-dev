...
export function FeaturesBlock({
  ...
  return (
    <section className="w-full">
      ...
      <div className="grid w-full grid-cols-1 md:grid-cols-12 gap-8 sm:gap-10 md:gap-12 px-5 sm:px-8 md:px-10 lg:px-[65px] border-b border-gray-200">
        ...
        <div className="
          ...
          <p
            ...
            className="
              ...
              max-w-prose md:max-w-none tracking-normal md:tracking-[-2.8px]
            "
            style={{ fontSize: "clamp(20px, 4vw, 46px)", lineHeight: "normal" }}
          >
            {description}
          </p>
        </div>
