...
export function AICardsBlock({ Title, Cards, layout }: AICardsBlockProps) {
  ...
  const isLeftLayout = layout === "left_layout";
  ...
  const gridClass = isSixCardsLayout
    ...
    : colsByCount[Cards?.length as keyof typeof colsByCount] ?? colsByCount[4];
              ...
              return (
                ...
                >
                  ...
                  <div className="relative">
                    <h3 className="mb-1 text-lg font-agenda-medium leading-[1.3] text-white">
                      {card.Title}
                    </h3>

                    <p className="text-sm font-agenda-regular leading-[1.5] text-white/70">
                      {card.description}
                    </p>
                  </div>
                </div>
