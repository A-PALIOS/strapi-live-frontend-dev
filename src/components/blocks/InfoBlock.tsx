  ...
  */
  ...
  return (
    <section className="bg-white overflow-x-clip"> {/* clip any tiny overflow */}
      ...
      viewBox="0 0 120 40"
      className="hidden lg:block h-6 w-20 shrink-0"  fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {cta && (
            <Link
              ...
              className="group inline-flex items-center gap-2 text-lg md:text-[24px] font-agenda-regular uppercase tracking-wide text-gray-900 hover:text-[#1E9BFB]"
            >
              {cta.text}
              <svg
                viewBox="0 0 24 24"
